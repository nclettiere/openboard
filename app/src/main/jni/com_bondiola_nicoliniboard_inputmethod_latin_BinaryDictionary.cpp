...
static const JNINativeMethod sMethods[] = {
    ...
    },
    {
        ...
        const_cast<char *>(
                "(J[Lcom/bondiola/nicoliniboard/inputmethod/latin/utils/WordInputEventForPersonalization;I)I"),
...
int register_BinaryDictionary(JNIEnv *env) {
    const char *const kClassPathName = "com/bondiola/nicoliniboard/inputmethod/latin/BinaryDictionary";
