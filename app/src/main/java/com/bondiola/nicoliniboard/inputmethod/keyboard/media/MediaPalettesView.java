...
import com.bondiola.nicoliniboard.inputmethod.compat.TabHostCompat;
...
import com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardLayoutSet;
...
import com.bondiola.nicoliniboard.inputmethod.latin.AudioAndHapticFeedbackManager;
...
public final class MediaPalettesView extends LinearLayout
    ...
    public MediaPalettesView(final Context context, final AttributeSet attrs) {
        this(context, attrs, R.attr.emojiPalettesViewStyle);
    }

    public MediaPalettesView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        final TypedArray emojiPalettesViewAttr = context.obtainStyledAttributes(attrs,
                R.styleable.MediaPalettesView, defStyle, R.style.MediaPalettesView);
        ...
        mCategoryIndicatorEnabled = emojiPalettesViewAttr.getBoolean(
                R.styleable.MediaPalettesView_categoryIndicatorEnabled, false);
        mCategoryIndicatorDrawableResId = emojiPalettesViewAttr.getResourceId(
                R.styleable.MediaPalettesView_categoryIndicatorDrawable, 0);
        mCategoryIndicatorBackgroundResId = emojiPalettesViewAttr.getResourceId(
                R.styleable.MediaPalettesView_categoryIndicatorBackground, 0);
        mCategoryPageIndicatorColor = emojiPalettesViewAttr.getColor(
                R.styleable.MediaPalettesView_categoryPageIndicatorColor, 0);
        mCategoryPageIndicatorBackground = emojiPalettesViewAttr.getColor(
                R.styleable.MediaPalettesView_categoryPageIndicatorBackground, 0);
