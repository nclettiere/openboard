...
internal class KeyCodeDescriptionMapper private constructor() {
     ...
     */
    fun getDescriptionForKey(context: Context, keyboard: com.bondiola.nicoliniboard.inputmethod.keyboard.Keyboard?,
                             key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key, shouldObscure: Boolean): String? {
        val code = key.code
        if (code == com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SWITCH_ALPHA_SYMBOL) {
            val description = getDescriptionForSwitchAlphaSymbol(context, keyboard)
            if (description != null) {
                return description
            }
        }
        if (code == com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SHIFT) {
            return getDescriptionForShiftKey(context, keyboard)
        }
        if (code == com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_ENTER) { // The following function returns the correct description in all action and
// regular enter cases, taking care of all modes.
            return getDescriptionForActionKey(context, keyboard, key)
        }
        if (code == com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_OUTPUT_TEXT) {
        ...
        if (code != com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_UNSPECIFIED) { // If the key description should be obscured, now is the time to do it.
    ...
    fun getDescriptionForCodePoint(context: Context, codePoint: Int): String? { // If the key description should be obscured, now is the time to do it.
        ...
        return if (Character.isDefined(codePoint) && !Character.isISOControl(codePoint)) {
            com.bondiola.nicoliniboard.inputmethod.latin.common.StringUtils.newSingleCodePointString(codePoint)
        } else null
    }
    ...
    companion object {
        ...
        private fun getDescriptionForSwitchAlphaSymbol(context: Context,
                                                       keyboard: com.bondiola.nicoliniboard.inputmethod.keyboard.Keyboard?): String? {
            val keyboardId = keyboard!!.mId
            val elementId = keyboardId.mElementId
            val resId: Int
            resId = when (elementId) {
                com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET, com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET_AUTOMATIC_SHIFTED, com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET_MANUAL_SHIFTED, com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED, com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCKED -> R.string.spoken_description_to_symbol
                com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_SYMBOLS, com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_SYMBOLS_SHIFTED -> R.string.spoken_description_to_alpha
                com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_PHONE -> R.string.spoken_description_to_symbol
                com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_PHONE_SYMBOLS -> R.string.spoken_description_to_numeric
                else -> {
        ...
        private fun getDescriptionForShiftKey(context: Context,
            ...
            val resId: Int
            resId = when (elementId) {
                com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED, com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCKED -> R.string.spoken_description_caps_lock
                com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET_AUTOMATIC_SHIFTED, com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_ALPHABET_MANUAL_SHIFTED -> R.string.spoken_description_shift_shifted
                com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_SYMBOLS -> R.string.spoken_description_symbols_shift
                com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardId.ELEMENT_SYMBOLS_SHIFTED -> R.string.spoken_description_symbols_shift_shifted
         ...
         */
        private fun getDescriptionForActionKey(context: Context, keyboard: com.bondiola.nicoliniboard.inputmethod.keyboard.Keyboard?,
                                               key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key): String {
            val keyboardId = keyboard!!.mId
    ...
    init { // Special non-character codes defined in Keyboard
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SPACE, R.string.spoken_description_space)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_DELETE, R.string.spoken_description_delete)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_ENTER, R.string.spoken_description_return)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SETTINGS, R.string.spoken_description_settings)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SHIFT, R.string.spoken_description_shift)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SHORTCUT, R.string.spoken_description_mic)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SWITCH_ALPHA_SYMBOL, R.string.spoken_description_to_symbol)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_TAB, R.string.spoken_description_tab)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_LANGUAGE_SWITCH,
                R.string.spoken_description_language_switch)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_ACTION_NEXT, R.string.spoken_description_action_next)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_ACTION_PREVIOUS,
                R.string.spoken_description_action_previous)
        mKeyCodeMap.put(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_EMOJI, R.string.spoken_description_emoji)
