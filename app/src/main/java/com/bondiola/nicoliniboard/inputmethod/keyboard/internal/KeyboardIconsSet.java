...
public final class KeyboardIconsSet {
    ...
    public static final String NAME_MEDIA_ACTION_KEY = "media_action_key";
    public static final String NAME_MEDIA_NORMAL_KEY = "media_normal_key";
    ...
    private static final Object[] NAMES_AND_ATTR_IDS = {
        ...
        NAME_MEDIA_ACTION_KEY,            R.styleable.Keyboard_iconMediaActionKey,
        NAME_MEDIA_NORMAL_KEY,            R.styleable.Keyboard_iconMediaNormalKey,
    };
