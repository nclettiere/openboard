...
class AccessibilityUtils private constructor() {
    ...
    val isAccessibilityEnabled: Boolean
        get() = com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils.Companion.ENABLE_ACCESSIBILITY && mAccessibilityManager!!.isEnabled
    ...
    fun shouldObscureInput(editorInfo: EditorInfo?): Boolean {
        ...
        return if (mAudioManager!!.isWiredHeadsetOn || mAudioManager!!.isBluetoothA2dpOn) {
            false
        } else com.bondiola.nicoliniboard.inputmethod.latin.utils.InputTypeUtils.isPasswordInputType(editorInfo.inputType)
     ...
     */
    fun setAutoCorrection(suggestedWords: com.bondiola.nicoliniboard.inputmethod.latin.SuggestedWords) {
        if (suggestedWords.mWillAutoCorrect) {
            mAutoCorrectionWord = suggestedWords.getWord(com.bondiola.nicoliniboard.inputmethod.latin.SuggestedWords.INDEX_OF_AUTO_CORRECTION)
    ...
    fun announceForAccessibility(view: View, text: CharSequence?) {
        if (!mAccessibilityManager!!.isEnabled) {
            Log.e(com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils.Companion.TAG, "Attempted to speak when accessibility was disabled!")
            return
        }
...
// the screen reader to make it speak.
        ...
        event.packageName = com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils.Companion.PACKAGE
        event.className = com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils.Companion.CLASS
...
// announce events.
        ...
        if (viewParent == null || viewParent !is ViewGroup) {
            Log.e(com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils.Companion.TAG, "Failed to obtain ViewParent in announceForAccessibility")
            return
        }
    ...
    companion object {
        private val TAG = com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils::class.java.simpleName
        private val CLASS = com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils::class.java.name
        private val PACKAGE = com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils::class.java.getPackage()!!.name
        val instance = com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils()
        /*
     ...
     */
        ...
        fun init(context: Context) {
            if (!com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils.Companion.ENABLE_ACCESSIBILITY) return
            // These only need to be initialized if the kill switch is off.
            com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils.Companion.instance.initInternal(context)
        }
