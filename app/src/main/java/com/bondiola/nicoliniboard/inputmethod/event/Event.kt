package com.bondiola.nicoliniboard.inputmethod.event
    ...
    val textToCommit: CharSequence?
        get() {
            ...
            when (mEventType) {
                ...
                EVENT_TYPE_INPUT_KEYPRESS -> return com.bondiola.nicoliniboard.inputmethod.latin.common.StringUtils.newSingleCodePointString(mCodePoint)
...
// or dead-abovering.
        ...
        fun createHardwareKeypressEvent(codePoint: Int, keyCode: Int,
            ...
            return Event(EVENT_TYPE_INPUT_KEYPRESS, null /* text */, codePoint, keyCode,
                    com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.EXTERNAL_KEYBOARD_COORDINATE, com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.EXTERNAL_KEYBOARD_COORDINATE,
        ...
        fun createEventForCodePointFromUnknownSource(codePoint: Int): Event { // TODO: should we have a different type of event for this? After all, it's not a key press.
            return Event(EVENT_TYPE_INPUT_KEYPRESS, null /* text */, codePoint, NOT_A_KEY_CODE,
                    com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.NOT_A_COORDINATE, com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.NOT_A_COORDINATE,
        ...
        fun createSuggestionPickedEvent(suggestedWordInfo: SuggestedWordInfo): Event {
            return Event(EVENT_TYPE_SUGGESTION_PICKED, suggestedWordInfo.mWord,
                    ...
                    com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.SUGGESTION_STRIP_COORDINATE, com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.SUGGESTION_STRIP_COORDINATE,
        ...
        fun createPunctuationSuggestionPickedEvent(
            ...
            return Event(EVENT_TYPE_SUGGESTION_PICKED, suggestedWordInfo.mWord, primaryCode,
                    NOT_A_KEY_CODE, com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.SUGGESTION_STRIP_COORDINATE,
                    com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.SUGGESTION_STRIP_COORDINATE, suggestedWordInfo, FLAG_NONE,
                    null /* next */)
        }
        ...
        fun createCursorMovedEvent(moveAmount: Int): Event {
            return Event(EVENT_TYPE_CURSOR_MOVE, null, NOT_A_CODE_POINT, NOT_A_KEY_CODE,
                    moveAmount, com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.NOT_A_COORDINATE, null, FLAG_NONE, null)
        }
