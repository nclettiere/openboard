...
/* Characters used to display placeholders for dead keys. */
        ...
        private const val ACCENT_DOT_BELOW = com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_PERIOD // approximate
        ...
        private const val ACCENT_HORN = com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SINGLE_QUOTE // approximate
        ...
        private const val ACCENT_STROKE = com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_DASH // approximate
        ...
        private const val ACCENT_GRAVE_LEGACY = com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_GRAVE_ACCENT
        private const val ACCENT_CIRCUMFLEX_LEGACY = com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_CIRCUMFLEX_ACCENT
        private const val ACCENT_TILDE_LEGACY = com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_TILDE
        /**
...
// simply returns the event as is. The majority of events will go through this path.
        ...
        if (event.isFunctionalKeyEvent) {
            if (com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_DELETE == event.mKeyCode) { // Remove the last code point
