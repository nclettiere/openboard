...
import com.bondiola.nicoliniboard.inputmethod.dictionarypack.ActionBatch.MarkPreInstalledAction
...
// new strongly typed array of the correct size.
    ...
    override fun query(uri: Uri, projection: Array<String>?, selection: String?,
        ...
        com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Uri =", uri)
        ...
        return when (match) {
            DICTIONARY_V1_WHOLE_LIST, DICTIONARY_V2_WHOLE_LIST -> {
                ...
                com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("List of dictionaries with count", c.count)
...
// for LocaleUtils#getMatchLevel.
                    val matchLevel = com.bondiola.nicoliniboard.inputmethod.latin.common.LocaleUtils.getMatchLevel(wordListLocale, locale)
                    if (!com.bondiola.nicoliniboard.inputmethod.latin.common.LocaleUtils.isMatch(matchLevel)) { // The locale of this wordlist does not match the required locale.
