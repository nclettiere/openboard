...
open class KeyboardAccessibilityDelegate<KV : com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardView?>(protected val mKeyboardView: KV, protected val mKeyDetector: com.bondiola.nicoliniboard.inputmethod.keyboard.KeyDetector) : AccessibilityDelegateCompat() {
    ...
    private var mLastHoverKey: com.bondiola.nicoliniboard.inputmethod.keyboard.Key? = null


    protected open var lastHoverKey: com.bondiola.nicoliniboard.inputmethod.keyboard.Key?
        get() = mLastHoverKey
        set(key) {
            mLastHoverKey = key
        }
     ...
     */
    open var keyboard: com.bondiola.nicoliniboard.inputmethod.keyboard.Keyboard?
    get() = mKeyboard
    set(keyboard) {
        if (keyboard == null) {
            return
...
// cache the provider instance.
     ...
     */
    protected fun getHoverKeyOf(event: MotionEvent): com.bondiola.nicoliniboard.inputmethod.keyboard.Key? {
...
// off the keyboard area, then force a key press.
     ...
     */
    private fun simulateTouchEvent(touchAction: Int, key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key) {
     ...
     */
    protected open fun onHoverEnterTo(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key) {
        if (DEBUG_HOVER) {
     ...
     * @param key The currently hovered key.
     */
    protected fun onHoverMoveWithin(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key?) {}
     ...
     * @param key The currently hovered key.
     */
    protected open fun onHoverExitFrom(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key) {
        if (DEBUG_HOVER) {
     ...
     */
    open fun performLongClickOn(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key) { // A extended class should override this method to implement long press.
    }
