package com.bondiola.nicoliniboard.inputmethod.dictionarypack
...
class ActionBatch {
    ...
    class EnableAction(clientId: String, wordList: WordListMetadata?) : Action {
        ...
        override fun execute(context: Context?) {
            ...
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Enabling word list")
        ...
        init {
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("New EnableAction for client ", clientId, " : ", wordList)
            mClientId = clientId
            mWordList = wordList
        }
    }
    ...
    class DisableAction(clientId: String, wordlist: WordListMetadata?) : Action {
        ...
        override fun execute(context: Context?) {
            ...
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Disabling word list : $mWordList")
            val db: SQLiteDatabase = MetadataDbHelper.Companion.getDb(context, mClientId)
            val values: ContentValues = MetadataDbHelper.Companion.getContentValuesByWordListId(db,
                    mWordList.mId, mWordList.mVersion)!!
            val status = values.getAsInteger(MetadataDbHelper.Companion.STATUS_COLUMN)
...
// word list status to "available".
        ...
        init {
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("New Disable action for client ", clientId, " : ", wordlist)
            mClientId = clientId
            mWordList = wordlist
        }
    }
    ...
    class MakeAvailableAction(clientId: String, wordlist: WordListMetadata?) : Action {
        ...
        override fun execute(context: Context?) {
            ...
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Making word list available : $mWordList")
...
// yet, so we set the local filename to the empty string.
        ...
        init {
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("New MakeAvailable action", clientId, " : ", wordlist)
            mClientId = clientId
            mWordList = wordlist
        }
    }
    ...
    class MarkPreInstalledAction(clientId: String?, wordlist: WordListMetadata?) : Action {
        ...
        override fun execute(context: Context?) {
            ...
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Marking word list preinstalled : $mWordList")
...
// accidentally. The remote filename may be set by the application if it so wishes.
        ...
        init {
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("New MarkPreInstalled action", clientId, " : ", wordlist)
            mClientId = clientId
            mWordList = wordlist
        }
    }
    ...
    class UpdateDataAction(clientId: String, wordlist: WordListMetadata?) : Action {
        ...
        override fun execute(context: Context?) {
            ...
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Updating data about a word list : $mWordList")
        ...
        init {
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("New UpdateData action for client ", clientId, " : ", wordlist)
            mClientId = clientId
            mWordList = wordlist
        }
    }
    ...
    class ForgetAction(clientId: String, wordlist: WordListMetadata?,
        ...
        override fun execute(context: Context?) {
            ...
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Trying to remove word list : $mWordList")
            val db: SQLiteDatabase = MetadataDbHelper.Companion.getDb(context, mClientId)
            val values: ContentValues = MetadataDbHelper.Companion.getContentValuesByWordListId(db,
                    mWordList.mId, mWordList.mVersion)!!
            if (null == values) {
...
// be accessible any more.
        ...
        init {
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("New TryRemove action for client ", clientId, " : ", wordlist)
            mClientId = clientId
            mWordList = wordlist
    ...
    class StartDeleteAction(clientId: String, wordlist: WordListMetadata?) : Action {
        ...
        override fun execute(context: Context?) {
            ...
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Trying to delete word list : $mWordList")
            val db: SQLiteDatabase = MetadataDbHelper.Companion.getDb(context, mClientId)
            val values: ContentValues = MetadataDbHelper.Companion.getContentValuesByWordListId(db,
                    mWordList.mId, mWordList.mVersion)!!
            if (null == values) {
        ...
        init {
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("New StartDelete action for client ", clientId, " : ", wordlist)
            mClientId = clientId
            mWordList = wordlist
        }
    }
...
// this way.
        ...
        init {
            com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("New FinishDelete action for client", clientId, " : ", wordlist)
            mClientId = clientId
            mWordList = wordlist
        }
    }
    ...
    fun execute(context: Context?, reporter: ProblemReporter?) {
        com.bondiola.nicoliniboard.inputmethod.latin.utils.DebugLogUtils.l("Executing a batch of actions")
