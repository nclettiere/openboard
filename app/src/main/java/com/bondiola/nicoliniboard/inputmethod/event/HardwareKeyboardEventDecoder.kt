...
// the key for 'A' or Space, but also Backspace or Ctrl or Caps Lock.
        ...
        if (KeyEvent.KEYCODE_DEL == keyCode) {
            return Event.Companion.createHardwareKeypressEvent(Event.Companion.NOT_A_CODE_POINT, com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_DELETE,
...
// Latin IME decide what to do with it.
                if (keyEvent.isShiftPressed) {
                    Event.Companion.createHardwareKeypressEvent(Event.Companion.NOT_A_CODE_POINT,
                            com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_SHIFT_ENTER, null /* next */, isKeyRepeat)
                } else Event.Companion.createHardwareKeypressEvent(com.bondiola.nicoliniboard.inputmethod.latin.common.Constants.CODE_ENTER, keyCode,
                        null /* next */, isKeyRepeat)
