...
// content://com.bondiola.nicoliniboard.inputmethod.latin.dictionarypack/clientId/list?procotol=2
        ...
        return try {
            ...
            do {
                ...
                val matchLevel = com.bondiola.nicoliniboard.inputmethod.latin.common.LocaleUtils.getMatchLevel(systemLocaleString, localeString)
                val matchLevelString = com.bondiola.nicoliniboard.inputmethod.latin.common.LocaleUtils.getMatchLevelSortedString(matchLevel)
