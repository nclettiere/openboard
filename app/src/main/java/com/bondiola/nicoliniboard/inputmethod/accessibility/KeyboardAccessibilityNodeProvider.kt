 ...
 *
 */
class KeyboardAccessibilityNodeProvider<KV : com.bondiola.nicoliniboard.inputmethod.keyboard.KeyboardView?>(keyboardView: KV,
    ...
    private val mAccessibilityUtils: com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils
    /** Temporary rect used to calculate in-screen bounds.  */
    private val mTempBoundsInScreen = Rect()
    /** The parent view's cached on-screen location.  */
    private val mParentLocation = com.bondiola.nicoliniboard.inputmethod.latin.common.CoordinateUtils.newInstance()
    ...
    private var mKeyboard: com.bondiola.nicoliniboard.inputmethod.keyboard.Keyboard? = null
     ...
     */
    fun setKeyboard(keyboard: com.bondiola.nicoliniboard.inputmethod.keyboard.Keyboard?) {
        mKeyboard = keyboard
    }

    private fun getKeyOf(virtualViewId: Int): com.bondiola.nicoliniboard.inputmethod.keyboard.Key? {
        if (mKeyboard == null) {
            return null
        }
    ...
    private fun getVirtualViewIdOf(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key): Int {
        if (mKeyboard == null) {
            return View.NO_ID
        }
        val sortedKeys = mKeyboard!!.sortedKeys
     ...
     */
    fun createAccessibilityEvent(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key, eventType: Int): AccessibilityEvent {
    ...
    fun onHoverEnterTo(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key) {
...
// announcements.
    ...
    fun onHoverExitFrom(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key) {
...
// this View, i.e. the root of the virtual sub-tree.
        ...
        mTempBoundsInScreen.offset(
                com.bondiola.nicoliniboard.inputmethod.latin.common.CoordinateUtils.x(mParentLocation), com.bondiola.nicoliniboard.inputmethod.latin.common.CoordinateUtils.y(mParentLocation))
...
// See {@link #onHoverEnterTo(Key)} and {@link #onHoverExitFrom(Key)}.
     ...
     */
    fun performActionForKey(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key, action: Int): Boolean {
        return when (action) {
     ...
     */
    fun sendAccessibilityEventForKey(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key, eventType: Int) {
     ...
     */
    private fun getKeyDescription(key: com.bondiola.nicoliniboard.inputmethod.keyboard.Key): String? {
        val editorInfo = mKeyboard!!.mId.mEditorInfo
        val shouldObscure = mAccessibilityUtils.shouldObscureInput(editorInfo)
        val currentSettings = com.bondiola.nicoliniboard.inputmethod.latin.settings.Settings.getInstance().current
    ...
    init {
        ...
        mAccessibilityUtils = com.bondiola.nicoliniboard.inputmethod.accessibility.AccessibilityUtils.Companion.instance
